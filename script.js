document.addEventListener('DOMContentLoaded', function () {
        ...
        .then(function (response) {
          if (response.ok) {
            ...
            getValidatableFields().forEach(function (field) {
              const wrapper = field.closest('.form-group, .field-wrapper, [data-field]') || field.parentElement;
              wrapper.classList.remove(FIELD_SUCCESS_CLASS, FIELD_ERROR_CLASS);
            });
  ...
  function initScrollAnimations() {
    const elements = document.querySelectorAll('[data-animate], .fade-in, .slide-up, .slide-in');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "טסט אינסטלטור משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1cc8c65e-6e33-4687-aeb0-e142f1b8f622',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1cc8c65e-6e33-4687-aeb0-e142f1b8f622';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1cc8c65e-6e33-4687-aeb0-e142f1b8f622';
